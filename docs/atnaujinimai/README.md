...
**2022-12-10**. Python skyriuje pridėta medžiagos į šias temas: "patikrinimo sąlyga if", "loginiai patikrinimo operatoriai", "žinių užtvirtinimas (1)", "range() arba ranges".
